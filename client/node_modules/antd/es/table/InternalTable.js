...
import { mergeClassNames, mergeStyles, resolveStyleOrClass, useMergeSemantic, useSemanticRootStyle } from '../_util/hooks/useMergeSemantic';
...
const InternalTable = (props, ref) => {
  ...
  const paginationClassNames = info => mergeClassNames({}, mergedClassNames.pagination, resolveStyleOrClass(mergedPagination.classNames, info));
  const paginationStyles = info => mergeStyles(resolveStyleOrClass(mergedPagination.styles, info), mergedStyles.pagination);
