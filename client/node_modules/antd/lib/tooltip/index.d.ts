...
interface LegacyTooltipProps extends Partial<Omit<RcTooltipProps, 'afterVisibleChange' | 'arrowContent' | 'children' | 'classNames' | 'defaultVisible' | 'destroyTooltipOnHide' | 'motion' | 'onVisibleChange' | 'overlay' | 'popupVisible' | 'showArrow' | 'styles' | 'visible'>> {
    motion?: {
        motionName?: string;
    };
